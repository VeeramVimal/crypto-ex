! function(e, t) {
    ...
    var t = function() {
        function e(e, t, r) {
            this._exchangesList = [], this._symbolsInfo = {}, this._symbolsList = [], this._datafeedUrl = e, this._datafeedSupportedResolutions = t, this._requester = r, this._readyPromise = this._init(), this._readyPromise.catch(function(e) {
                console.error("SymbolsStorage: Cannot init, error=" + e.toString())
            })
        } /*"NYSE", "FOREX", "AMEX"   , "ETH/BTC", "XMR/BTC","XRP/BTC", "LTC/BTC", "BTC/USD", "ETH/BTC"*/
        return e.prototype.resolveSymbol = function(t) {
            var r = this;
            return this._readyPromise.then(function() {
                var e = r._symbolsInfo[t];
                return void 0 === e ? Promise.reject("") : Promise.resolve(e)
            })
    ...
    var o = function() {
        function e(e, t, r, s) {
            ...
            this._configuration = {
                ...
                supported_resolutions: ["1","3", "5", "60", "D", "2D","W","3W","M","6M"],
                supports_marks: true,
                supports_time:true,
                ...
                null === e && (e = {
                    ...
                    exchanges:[
                        ...
                        {"value":"Bittrex","name":"Bittrex","desc":"Bittrex"},
