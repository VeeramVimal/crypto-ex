                          ...
                          <div className="row">
                            ...
                            <div className="col-6">
                              ...
                              <p className="order-bookexchange-modal-text-4">
                                {props.decimalValue(
                                  traHisDetails.orderDetails["Amount"]
                                )}
                              </p>
                              <p className="order-bookexchange-modal-text-4">
                                {dateFormat(
                              ...
                              <p className="order-bookexchange-modal-text-4">
                                {props.decimalValue(
                                  traHisDetails.orderDetails["Before debit"]
                                )}{" "}
                                {traHisDetails.orderDetails["Debit currency"]}
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="col-lg-6">
                          <div className="row">
                            ...
                            <div className="col-6">
                              ...
                              <p className="order-bookexchange-modal-text-4">
                                {props.decimalValue(
                                  traHisDetails.orderDetails["Price"]
                                )}
                              </p>
                              <p className="order-bookexchange-modal-text-4">
                              ...
                              <p className="order-bookexchange-modal-text-4 capitalizeText">
                                {props.decimalValue(
                                  traHisDetails.orderDetails["After debit"]
                                )}{" "}
                                {traHisDetails.orderDetails["Debit currency"]}
                              </p>
                            </div>
