...
const validationSchema = yup.object({
  ...
  email: yup.string("Enter the email address").required("Email is required"),
  myfile1: yup.mixed().required("Upload proof is required"),
});
const impsvalidationSchema = yup.object({
  accountNo: yup
    .string("Enter enter the bank account number")
...
const upivalidationSchema = yup.object({
  UPIID: yup.string("Enter your UPI ID").required("UPI ID is required"),
});
...
const otpvalidationSchema = yup.object({
  OTPCode: yup.string("Enter the 2FA").required("2FA Code is required"),
});
...
export default function Addpaymentmethod(props) {
  ...
  console.log("mypaymentDetails:", mypaymentDetails);
  const initialValues = () => {
      ...
      <div className="p2p-trade-top-section add-payment-method-p2p-user-center">
        ...
        <section>
          <div className="container py-3">
            <div className="row">
              <div className="col">
                <span className="add-payment-method-heading-styling">
                  Add payment method
                </span>
              </div>
            </div>
        ...
        <section>
                    ...
                    <div className="container add-payment-method-top-banner pb-5">
                      <div className="row justify-content-center align-items-center ">
                        <div className="col-lg-5 ">
                          ...
                          <div>
                            <span className="add-payment-method-text-1">
                              Name
                            </span>
                            <input
                              type="text"
                              className="form-control-payment-method"
                              name="username"
                          ...
                          <div className="mt-4">
                            ...
                            />
                            {errors.UPIID ? (
                              <small className="invalid-UPIID error">
                                {errors.UPIID}
                              </small>
                            ) : null}
                          </div>
                          <div className="mt-4">
                            ...
                            <div>
                              <img
                                className="payment-qrcode-optional-image"
                                src={files?.source || defaultSrc}
                                alt="preview"
                              />
                              <br />
                              <button
                                className="payment-qrcode-optional-button mt-3"
                                name="upifile"
                                type="button"
                                onClick={() =>
                                  selectFiles(
                            ...
                            <span className="add-payment-method-text-2">
                          ...
                          <div className="row mt-5">
                            <div className="col">
                              <div className="d-grid">
                                <button
                                  className="add-payment-method-cancel-button"
                                  type="button"
                                >
                                  Cancel
                                </button>
                            ...
                            <div className="col">
                              <div className="d-grid">
                                <button
                                  className="add-payment-method-confirm-button px-3"
                                  type="button"
                      ...
                      <div className="row justify-content-center align-items-center ">
                        <div className="col-lg-5 ">
                          ...
                          <div className="mt-4">
                            ...
                            />
                            {errors.account ? (
                              <small className="invalid-account error">
                                {errors.account}
                              </small>
                            ) : null}
                          </div>
          ...
          {(paymentDetails?.name == "IMPS" ||
            paymentDetails?.name == "Bank") && (
            <Formik
              initialValues={initialValues()}
                        ...
                        <div className="col-lg-5 ">
                          ...
                          <div className="mt-4">
                            ...
                            <input
                              ...
                              onBlur={handleBlur}
                              error={
                                touched.accountNo && Boolean(errors.accountNo)
                              }
                              helperText={touched.accountNo && errors.accountNo}
                            />
                            {errors.accountNo ? (
                              <small className="invalid-accountNo error">
                                {errors.accountNo}
                              </small>
                            ) : null}
                          </div>
                          ...
                          <div className="mt-4">
                            ...
                            />
                            {errors.branch ? (
                              <small className="invalid-branch error">
                                {errors.branch}
                              </small>
                            ) : null}
                          </div>
        ...
        <Modal
          show={paymentverificationForm}
          onHide={() => setpaymentverificationForm(false)}
        >
                ...
                <div className="row mt-4">
                  ...
                  <div className="input-group">
                    <input
                      ...
                      error={
                        formikTFAverify.touched.OTPCode &&
                        Boolean(formikTFAverify.errors.OTPCode)
                      }
                      helperText={
                        formikTFAverify.touched.OTPCode &&
                        formikTFAverify.errors.OTPCode
                      }
                    />
                  </div>
                  {formikTFAverify.errors.OTPCode ? (
