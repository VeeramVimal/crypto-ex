...
export default function LaunchPadTableComp(props) {
...
//   };
  ...
  useEffect(() => {
    if (props && props.userLaunchData) {
      setWalletData(props.userLaunchData);
    }
  }, [props]);
            ...
            <TableBody>
              ...
              {stableSort(
                ...
                .map((row, index) => {
                  ...
                  const withOutPairName = row.userId.toUpperCase();
                  const withOutPairSym = row.userId.replace(/_/g, '').toUpperCase();
