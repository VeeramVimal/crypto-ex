...
// import { BsLink45Deg, BsFillArrowRightCircleFill } from "react-icons/bs";
        ...
        <div className="col-lg-12">
          ...
          <table className="table mt-4">
            ...
            <tbody>
              ...
              <tr key={i}>
                <td data-label="Time">
                  {/* 2022-03-04 <span className="me-2">12.31</span> */}
              ...
              {/* <tr>
                ...
                <td data-label="Deposit wallet">Deposit</td>
                <td data-label="Asset">USDT</td>
                <td data-label="Amount">15.4434324</td>
                <td data-label="Destination">
                  <label className="dest-addres-ellipsis">
                    0xbc8577d1a3fdefe74e516fdf2172de31d657d6eb
                  </label>
                  <span>
                    <BsLink45Deg className="dest-addres-link" />
                  </span>
