...
const defaultProps = {
  ...
  // image: 'https://academy.education.investing.com/wp-content/uploads/2022/03/bull-bear-article.jpg', // Path to the image file
...
export default class TVChartContainer extends React.PureComponent {
  ...
  loadChart() {
    ...
    const widgetOptions = {
      ...
      overrides: {
        ...
        "paneProperties.backgroundType": "solid",
        "paneProperties.legendProperties.showBarChange":"red",
  ...
  socketCall() {
    this.socketConnection.on("pairResponse", (e) => {
      if (
