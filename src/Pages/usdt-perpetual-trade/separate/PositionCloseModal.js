...
const PositionCloseModal = forwardRef((props, ref) => {
    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                {
                    orderData.orderType == 'market' && <div>
                        Are you sure to close market
                    </div>
                }

                {
                    orderData.orderType == 'limit' && <div>
                        <p className="trade-text-6 mt-3">Price ({pairDetails && pairDetails.toCurrency && pairDetails.toCurrency.currencySymbol})</p>
                        <div className="input-group mb-3">
                            ...
                            />
                            <span className="input-group-text" id="basic-addon1">{pairDetails && pairDetails.toCurrency && pairDetails.toCurrency.currencySymbol}</span>
                        </div>
                    </div>
                }
