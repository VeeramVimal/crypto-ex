              ...
              <ul className="nav nav-pills" id="pills-tab" role="tablist">
                <li className="nav-item" role="presentation" onClick={() => setUserHistoryTab("positions")}>
                  <button
                    ...
                    aria-selected="false"
                  >
                    Positions({props.userTradeDetails.positionOrders ? props.userTradeDetails.positionOrders.length : 0})
                  </button>
                </li>
                ...
                <li className="nav-item" role="presentation" onClick={() => setUserHistoryTab("Closed PnL")}>
                  <button
                    className="nav-link"
            ...
            <>
              <div className="px-2 trading-page-order-table-details-section pt-3">
                {userHistoryTab == "positions" &&
                  <PositionTab
                    positionOrders={props.userTradeDetails && props.userTradeDetails.positionOrders}
                  ...
                  <table className="table">
                    ...
                    <tbody>
                      {userTradeDetails.activeOrders.length > 0 && userTradeDetails.activeOrders.map((elem, i) => {
                        ...
                        const tpshow = (tpSl == 'tp') ? 'Mark price >=' : (tpSl == 'sl') ? 'Mark price <=' : "";
                        ...
                        return <tr key={i}>
                          ...
                          <td data-label="Conditions">
                            {tpshow}
                            {tpshow ? props.decimalValue(price, decimalValue) : "-"}
                          </td>
                ...
                {
                  userHistoryTab == 'Order History' && <OrderHistory {...props} />
                }
