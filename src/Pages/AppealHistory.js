...
import {
  Box,Typography,InputLabel,FormControl,Select,MenuItem,
  ...
  return (
    <div>
      ...
      <Modal show={cancelformOpen} onHide={()=>setcancelformOpen(false)}>
          ...
          <button className="add-payment-method-confirm-button px-3 " type="button" disabled={cancelReason!="" ? false : true} onClick={()=>cancelOrder()}>Confirm</button>
          {/* <button type="button" className="btn btn-next">Refresh</button> */}
          </div>
          </Modal.Body>
      </Modal> 
        ...
        <Modal.Body>
          <form onSubmit={formik.handleSubmit}>   
            ...
            <div className='row mt-5'>
              <div className='col'>
                <div className="d-grid">
                  <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={()=>setappealformOpen(false)}>Cancel</button><br/>
                  <button className="add-payment-method-confirm-button px-3" type="submit" disabled={isLoading1}>Appeal</button>
                </div>
              </div>
            </div>
          </form>
          ...
          <form onSubmit={formikhelpcenter.handleSubmit}>   
            <div className=" justify-content-center align-items-center ">
              <div className=" mt-4">
                ...
                {formikhelpcenter.errors.description ? <small className="invalid-description error">{formikhelpcenter.errors.description}</small> : null}
              </div>
            </div>
            <div className='row mt-5'>
              <div className='col'>
                <div className="d-grid">
                  <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={()=>sethelpcenterformOpen(false)}>Cancel</button>
                  <button className="add-payment-method-confirm-button px-3 mt-3" type="submit" disabled={isLoading1}>Submit</button>
                </div>
              </div>
            </div>
          </form>
